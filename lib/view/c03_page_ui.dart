      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final sectionGap = ((height * 0.025) * safeScale).clamp(12.0, 24.0);
            ...
            final socialBoxHeight =
                ((width * 0.10) * safeScale).clamp(32.0, 50.0);
            ...
            final helperSize = (12.0 * safeScale).clamp(11.0, 16.0);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Container(
                                  width: (25.0 * safeScale).clamp(22.0, 36.0),
                                  height: (25.0 * safeScale).clamp(22.0, 36.0),
                                  padding: EdgeInsets.all(
                                    (2.0 * safeScale).clamp(2.0, 4.0),
                                  ),
                                  decoration: BoxDecoration(
                                    color:
                                        const Color.fromARGB(255, 52, 167, 81),
                              ...
                              SizedBox(
                                  height: (10.0 * safeScale).clamp(8.0, 14.0)),
                              _label('Email', labelSize),
                              SizedBox(
                                  height: (10.0 * safeScale).clamp(8.0, 14.0)),
                              _field(
                                'ex: John.smith@gmail.com',
                              ...
                              SizedBox(
                                  height: (10.0 * safeScale).clamp(8.0, 14.0)),
                              _label('Confirm Password', labelSize),
                              SizedBox(
                                  height: (10.0 * safeScale).clamp(8.0, 14.0)),
                              _field(
                                '********',
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Icon(
                                      ...
                                      color: const Color.fromARGB(
                                          255, 52, 167, 81),
                                      size:
                                          (25.0 * safeScale).clamp(22.0, 34.0),
                                    ),
                                  ),
                                  SizedBox(
                                    width: (10.0 * safeScale).clamp(8.0, 14.0),
                                  ),
                                  Expanded(
                                    child: Text.rich(
                                      TextSpan(
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Text(
                                    ...
                                    style: GoogleFonts.poppins(
                                      fontSize:
                                          (15.0 * safeScale).clamp(14.0, 18.0),
                                      fontWeight: FontWeight.w600,
                                      color: const Color.fromARGB(
                                          255, 255, 255, 255),
                                    ),
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        border: OutlineInputBorder(
          borderRadius:
              BorderRadius.circular((10.0 * safeScale).clamp(8.0, 14.0)),
          borderSide: BorderSide.none,
        ),
        contentPadding: EdgeInsets.symmetric(
          vertical: (10.0 * safeScale).clamp(8.0, 14.0),
          horizontal: (10.0 * safeScale).clamp(10.0, 14.0),
        ),
        filled: true,
