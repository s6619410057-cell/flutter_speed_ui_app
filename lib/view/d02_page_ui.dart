      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final footerGap = ((height * 0.16) * safeScale).clamp(56.0, 180.0);
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                                height: (32.0 * safeScale).clamp(28.0, 46.0)),
                            _inputField('Enter your email', safeScale),
                            SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: Text(
                                  ...
                                  style: GoogleFonts.poppins(
                                    ...
                                    color:
                                        const Color.fromARGB(255, 95, 107, 125),
                            ...
                            SizedBox(
                                height: (25.0 * safeScale).clamp(20.0, 36.0)),
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text(
                                  ...
                                  style: GoogleFonts.poppins(
                                    fontSize:
                                        (18.0 * safeScale).clamp(16.0, 24.0),
                                    fontWeight: FontWeight.w500,
                                    color: Colors.white,
                                  ),
                                ),
                            ...
                            SizedBox(
                                height: (22.0 * safeScale).clamp(18.0, 32.0)),
                            Row(
                              children: [
                                Expanded(
                                  child: _socialBox(
                                ...
                                SizedBox(
                                    width:
                                        (12.0 * safeScale).clamp(10.0, 20.0)),
                                Expanded(
                                  child: _socialBox(
                                    safeScale,
                                    child: Image.asset(
